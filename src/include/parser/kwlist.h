...
PG_KEYWORD("coordinator", COORDINATOR, UNRESERVED_KEYWORD)      /* GPDB */
...
PG_KEYWORD("expand", EXPAND, UNRESERVED_KEYWORD) /* GPDB */
...
PG_KEYWORD("fullscan", FULLSCAN, UNRESERVED_KEYWORD)
...
PG_KEYWORD("initplan", INITPLAN, UNRESERVED_KEYWORD)      /* GPDB */
...
PG_KEYWORD("onlymaster", ONLYMASTER, UNRESERVED_KEYWORD)      /* GPDB */
...
PG_KEYWORD("persistently", PERSISTENTLY, UNRESERVED_KEYWORD) /* GPDB */
...
PG_KEYWORD("replicated", REPLICATED, UNRESERVED_KEYWORD) /* GPDB */
...
PG_KEYWORD("segments", SEGMENTS, UNRESERVED_KEYWORD)
